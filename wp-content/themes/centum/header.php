...
<!-- CSS
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/css/ict4ag.css" type="text/css" media="screen"/>
...
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-37645199-1']);
...
<a href="/"><img class="header-pic" style="max-width:107.4%" src="<?php echo get_template_directory_uri() ?>/images/header-hackathon.jpg" alt="" /></a>
<!-- Header
================================================== -->
