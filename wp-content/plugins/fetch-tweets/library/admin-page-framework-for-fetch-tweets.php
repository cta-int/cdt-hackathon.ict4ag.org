...
abstract class FetchTweets_AdminPageFramework_SettingsAPI extends FetchTweets_AdminPageFramework_Menu {
	...
	*/	
	...
	private function enqueueColorFieldScript( &$arrField ) {
		...
		$this->oProps->strScript .= FetchTweets_AdminPageFramework_Properties::getColorPickerScript();
	...
	protected function renderSettingField( $strFieldID, $strPageSlug ) {
		...
		$oField = new FetchTweets_AdminPageFramework_InputField( $arrField, $this->oProps->arrOptions, $this->arrFieldErrors, $this->oMsg );
...
abstract class FetchTweets_AdminPageFramework extends FetchTweets_AdminPageFramework_SettingsAPI {
    ...
    */			
	...
	public function __construct( $strOptionKey=null, $strCallerPath=null, $strCapability=null, $strTextDomain=null ){
		...
		// Objects
		$this->oProps = new FetchTweets_AdminPageFramework_Properties( $strClassName, $strOptionKey, $strCapability );
	...
	*/	
	...
	public function addStyle() {
		...
		echo "<style type='text/css' id='admin-page-framework-style'>" 
			. $this->oUtil->addAndApplyFilters( $this, $this->oUtil->getFilterArrayByPrefix( self::$arrPrefixes['style_'], $this->oProps->strClassName, $strPageSlug, $strTabSlug, false ), FetchTweets_AdminPageFramework_Properties::$strDefaultStyle )
			. "</style>";
	}
...
abstract class FetchTweets_AdminPageFramework_PostType {	
	...
	*/
	public function __construct( $strPostType, $arrArgs=array(), $strCallerPath=null ) {
		...
		// Objects
		$this->oUtil = new FetchTweets_AdminPageFramework_Utilities;
		$this->oProps = new FetchTweets_AdminPageFramework_PostType_Properties;
...
abstract class FetchTweets_AdminPageFramework_MetaBox extends FetchTweets_AdminPageFramework_MetaBox_Help {
	...
	*/ 		
	...
	function __construct( $strMetaBoxID, $strTitle, $vPostTypes=array( 'post' ), $strContext='normal', $strPriority='default', $strCapability='edit_posts', $strTextDomain='admin-page-framework' ) {
		...
		$this->oMsg = new FetchTweets_AdminPageFramework_Messages( $strTextDomain );
		$this->oDebug = new FetchTweets_AdminPageFramework_Debug;
		$this->oProps = new FetchTweets_AdminPageFramework_MetaBox_Properties;
	...
	*/ 
	...
	public function addStyle() {
		...
		// Print out the filtered styles.
		$this->oProps->strStyle = $this->oUtil->addAndApplyFilters( $this, "style_{$this->oProps->strClassName}", FetchTweets_AdminPageFramework_Properties::$strDefaultStyle );
		if ( ! empty( $this->oProps->strStyle ) )
	...
	private function getField( $arrField ) {
		...
		$oField = new FetchTweets_AdminPageFramework_InputField( $arrField, $this->oProps->arrOptions, array(), $this->oMsg );	// currently error arrays are not supported for meta-boxes 
